      ...
      <div class="navbar-collapse collapse" id="navbar">
          <ul class="nav navbar-nav">
              ...
              <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="wallet")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('admin/wallet') }}"> uronWallet</a>
              </li>
              <?php } ?>
              ...
              <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="report")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('admin/report') }}"> Laporan</a>
              </li>
              <?php } ?>
              ...
              <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="accountant")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('admin/accountant') }}"> Daftar Akun</a>
              </li>
              <?php } ?>
              ...
              <li class="dropdown <?=(Request::segment(1)=="admin" && Request::segment(2)=="transaction" && in_array(array("bank","purchase","sale","fee"),Request::segment(3)))?"active":""?>">
                  ...
                  <ul role="menu" class="dropdown-menu">
                      <?php if($previlege_model->isAllow($login->id_user,$login->id_department,"admin-transaction-bank-show")){?>
                        <li <?=(Request::segment(1)=="admin" && Request::segment(3)=="bank")?"class='active'":""?>><a href="{{ url('admin/transaction/bank') }}">Kas dan Bank</a></li>
                      <?php } ?>

                      <?php if($previlege_model->isAllow($login->id_user,$login->id_department,"admin-transaction-sale-show")){?>
                        <li <?=(Request::segment(1)=="admin" && Request::segment(3)=="sale")?"class='active'":""?>><a href="{{ url('admin/transaction/sale') }}">Penjualan</a></li>
                      <?php } ?>

                      <?php if($previlege_model->isAllow($login->id_user,$login->id_department,"admin-transaction-purchase-show")){?>
                        <li <?=(Request::segment(1)=="admin" && Request::segment(3)=="purchase")?"class='active'":""?>><a href="{{ url('admin/transaction/purchase') }}">Pembelian</a></li>
                      <?php } ?>

                      <?php if($previlege_model->isAllow($login->id_user,$login->id_department,"admin-transaction-cost-show")){?>
                        <li <?=(Request::segment(1)=="admin" && Request::segment(3)=="cost")?"class='active'":""?>><a href="{{ url('admin/transaction/cost') }}">Biaya</a></li>
                      <?php } ?>
                  </ul>
              </li>
              ...
              <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="shop")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('admin/shop') }}"> Toko</a>
              </li>
              <?php } ?>
              ...
              <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="vendor")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('admin/vendor') }}"> Vendor</a>
              </li>
              <?php } ?>
              ...
              <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="product")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('admin/product') }}"> Produk</a>
              </li>
              <?php } ?>
              ...
              <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="academy")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('admin/academy') }}"> uronAcademy</a>
              </li>
              <?php } ?>
              ...
              <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="master")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('admin/master') }}"> Master</a>
              </li>
              <?php } ?>
              ...
              <li <?=(Request::segment(1)=="master" && Request::segment(2)=="pengaturan")?"class='active'":""?>>
                  <a aria-expanded="false" role="button" href="{{ url('master/pengaturan') }}"> Pengaturan</a>
              </li>
              <?php } ?>
          </ul>
