<?php
  ...
  $statuses = array(
    "pre-production"    => "pre-production [LOGISTIK]",
    "pre-inisiation"    => "pre-production [RESEP]",
    "production"        => "production [DAPUR]",
    "post-production"   => "post-production [DAPUR]",
    "done"              => "Selesai",
  );

  $bgstatus = array(
    "pre-production"    => "",
    "pre-inisiation"    => "success",
    "production"        => "success",
    "post-production"   => "",
    "done"              => "",
  );
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tabel Permintaan Logistik</h5>
