            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tambah Bahan ke Produk "<?=$data->product_name?>"</h5>
                    </div>
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url($main_url.'/mrp/'.$data->id_product.'/store'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        <div class="form-group {{ ($errors->has('id_material')?"has-error":"") }}"><label class="col-sm-2 control-label">Bahan Baku</label>
                            <div class="col-sm-6 col-xs-12">
                                {!! Form::select('id_material', $bahan, null, ['class' => 'form-control thetarget']) !!}
