    ...
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ url($main_url.'/rumus/'.$data->id_product) }}"> Tambah Bahan Pada <?=$data->product_name?></a>
                    </li>
                    <li class="active">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tambah Produk ke dalam Produk "<?=$data->product_name?>"</h5>
                    </div>
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url($main_url.'/mrp/'.$data->id_product.'/store-product'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
