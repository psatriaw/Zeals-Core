            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Edit stock for "<?=$data->product_name?>" [<?=$data->product_code?>]</h5>
                    </div>
                    <div class="ibox-content">
                      ...
                      {!! Form::model($detail,['url' => url($main_url.'/stock/'.$data->id_product.'/update/'.$detail->id_product_stock), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
					    <!--
