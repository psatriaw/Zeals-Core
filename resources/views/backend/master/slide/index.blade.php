                                  ...
                                  <tr>
                                    ...
                                    <td class="nowrap">
                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['edit'])){?>
                                          <a href="{{ url($config['main_url'].'/edit/'.$value->id_slide) }}" class="btn btn-primary dim btn-xs"><i class="fa fa-paste"></i> edit</a>
                                      <?php }?>

                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['view'])){?>
                                          <a href="{{ url($config['main_url'].'/detail/'.$value->id_slide) }}" class="btn btn-white btn-xs"><i class="fa fa-eye"></i> detail</a>
                                      <?php }?>

                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['remove'])){?>
                                          <a data-id="{{ $value->id_slide }}" data-url="{{ url($config['main_url'].'/remove/') }}" class="btn btn-danger dim btn-xs confirm"><i class="fa fa-trash"></i> remove</a>
                                      <?php }?>
                                    </td>
                                  </tr>
                                  <?php
