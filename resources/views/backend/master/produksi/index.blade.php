                                  ...
                                  <tr class="<?=($value->status=="received")?"success":""?>">
                                    ...
                                    <td>
                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['manage'])){?>
                                          <a href="{{ url($main_url.'/edit/'.$value->id_production) }}" class="btn btn-primary dim btn-xs"><i class="fa fa-paste"></i> ubah</a>
                                      <?php }?>
                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['manage'])){?>
                                          <a href="{{ url($main_url.'/usage/'.$value->id_production) }}" class="btn btn-white btn-outline dim btn-xs"><i class="fa fa-cogs"></i> penggunaan</a>
                                      <?php }?>
