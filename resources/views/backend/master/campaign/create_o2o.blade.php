        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Tambah Campaign O2O Voucher</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                  ...
                  <br>
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            {!! Form::open(['url' => url('master/campaign/store'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate novalidate']) !!}
                            ...
                            <!-- id user -->
                            <div class="form-group {{ ($errors->has('id_penerbit')?"has-error":"") }}"><label class="col-sm-2 control-label">Brand</label>
                                <div class="col-sm-6 col-xs-12">
                                    <?php if(@$id_penerbit==''){ ?>
                            ...
                            <!-- campaign img -->
                            <div class="form-group {{ ($errors->has('photos')?"has-error":"") }}"><label class="col-sm-2 control-label">Banner<sub>(6:4)</sub></label>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="">
                                      <div class="row">
                                        <div class="col-sm-4">
                            ...
                            <div class="form-group {{ ($errors->has('budget')?"has-error":"") }}"><label class="col-sm-2 control-label">Budget</label>
                                <div class="col-sm-6 col-xs-12">
                            ...
                            <div class="form-group {{ ($errors->has('max_commission')?"has-error":"") }}"><label class="col-sm-2 control-label">Max Commission <sub>(per influencer)</sub></label>
                                <div class="col-sm-6 col-xs-12">
                                  <div class="input-group">
                                    <span class="input-group-addon">Rp.</span>
                            ...
                            <!-- campaign description -->
                            <div class="form-group {{ ($errors->has('campaign_instruction')?"has-error":"") }}"><label class="col-sm-2 control-label">Campaign Instruction</label>
                                <div class="col-sm-6 col-xs-12">
                            ...
                            <!-- Start date -->
                            <!-- campaign description -->
                            <div class="form-group {{ ($errors->has('campaign_do_n_dont')?"has-error":"") }}"><label class="col-sm-2 control-label">Do & Don't</label>
                                <div class="col-sm-6 col-xs-12">
