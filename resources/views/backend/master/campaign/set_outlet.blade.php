                  ...
                  <br>
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            {!! Form::model($detail,['url' => url('master/campaign/storeoutlet'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate novalidate']) !!}
                            ...
                            <?php if($outlets){ ?>
                              <div class="form-group {{ ($errors->has('outlet_name')?"has-error":"") }}"><label class="col-sm-2 control-label">Outlets</label>
