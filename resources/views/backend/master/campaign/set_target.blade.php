                  ...
                  <br>
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <!-- Target fund -->
                            <div class="form-group {{ ($errors->has('id_categories')?"has-error":"") }}"><label class="col-sm-2 control-label">Target Categories</label>
                                <div class="col-sm-6 col-xs-12">
                                    {!! Form::select('id_categories[]', $categories, null, ['class' => 'form-control categories' ,'multiple' => true]) !!}
                                    {!! $errors->first('id_categories', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
                                </div>
                            </div>

                            <!-- Target fund -->
                            <div class="form-group {{ ($errors->has('id_domisili')?"has-error":"") }}"><label class="col-sm-2 control-label">Domisili</label>
                                <div class="col-sm-6 col-xs-12">
                                    {!! Form::select('id_domisili[]', $domisili, null, ['class' => 'form-control categories' ,'multiple' => true]) !!}
                                    {!! $errors->first('id_domisili', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
                                </div>
                            </div>

                            <!-- Target fund -->
                            <div class="form-group {{ ($errors->has('estimation_affiliator')?"has-error":"") }}"><label class="col-sm-2 control-label">Affiliator</label>
                            ...
                            <div class="form-group {{ ($errors->has('tipe_url')?"has-error":"") }}"><label class="col-sm-2 control-label">URL Type</label>
                                <div class="col-sm-6 col-xs-12">
                                  {!! Form::select('tipe_url', ['slashed' => 'Slashed (https://domain/xx/yyy/enctypted_code))','formatted' => 'Formatted (https://domain/xxx_[encrypted_code]_yyy-zzz )', '' => 'Normal (https://domain/xxx-yyy?encrypted_code)'],'', ['class' => 'form-control']) !!}
                                  {!! $errors->first('tipe_url', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
                                </div>
                            </div>

                            <!-- campaign title -->
                            <div class="form-group {{ ($errors->has('landing_url')?"has-error":"") }}"><label class="col-sm-2 control-label">Landing/Target URL</label>
                                <div class="col-sm-6 col-xs-12">
                                    {!! Form::text('landing_url', null, ['class' => 'form-control','placeholder' => 'https://abcdef.com/register']) !!}
