    ...
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Ubah Gudang/Pabrik</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::model($data,['url' => url($main_url.'/update/'.$data->id_mitra), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group {{ ($errors->has('id_user')?"has-error":"") }}"><label class="col-sm-2 control-label">PIC</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::select('id_user', array(), null, ['class' => 'form-control thetarget','rows' => '3','id' => 'id_user']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('landmark')?"has-error":"") }}">
                            ...
                            <div class="col-sm-4 col-xs-12">
                              {!! Form::textarea('landmark', null, ['class' => 'form-control', 'id' => 'landmark', 'rows' => 2,'placeholder' => 'Landmark/penjelasan posisi tempat, misal:  Sebelah kantor telkom solo']) !!}
