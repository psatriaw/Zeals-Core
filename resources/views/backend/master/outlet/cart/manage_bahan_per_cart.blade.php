                            ...
                            <div class="col-sm-6">
                              <div class="form-group {{ ($errors->has('purchase_code')?"has-error":"") }}"><label class="col-sm-4 control-label">Kode Bahan</label>
                                  <div class="col-sm-8 col-xs-12">
                                      <input type="text" class="form-control disabled" readonly value="<?=@$material->material_code?>" name="purchase_code">
                                  </div>
                              </div>
                              <div class="form-group {{ ($errors->has('purchase_title')?"has-error":"") }}"><label class="col-sm-4 control-label">Nama Bahan</label>
                                  <div class="col-sm-8 col-xs-12">
                                      <input type="text" class="form-control disabled" readonly value="<?=$material->material_name?>" name="purchase_code">
                                  </div>
                              </div>
                                ...
                                foreach ($data as $key => $value) {
                                  ...
                                  <tr>
                                    ...
                                    <td  style="width:150px;" class="text-right">
                                        <input type="text" class="form-control disetujui" autocomplete="off" id_cart_detail_material="<?=$value->id_cart_detail_material?>" id="disetujui_quantity_<?=$value->id_material?>" value="<?=$value->disetujui_quantity?>">
                                    </td>
