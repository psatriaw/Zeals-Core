...
<div id="wrapper">
  ...
  <div id="page-wrapper" class="gray-bg">
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>Ubah Item Hasil Produksi</h2>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active">
                        <strong>Ubah Item Hasil Produksi</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Ubah Produk ke Produksi "<?=$production->production_code?>"</h5>
                    </div>
                    <div class="ibox-content">
                      ...
                      {!! Form::model($item,['url' => url($main_url.'/update/item/'.$production->id_outlet_production.'/'.$item->id_outlet_production_item), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        <div class="form-group {{ ($errors->has('id_product')?"has-error":"") }}"><label class="col-sm-2 control-label">Produk</label>
                            <div class="col-sm-3 col-xs-12">
                                {!! Form::select('id_product', $available, null, ['class' => 'form-control thetarget']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('quantity')?"has-error":"") }}"><label class="col-sm-2 control-label">Quantity</label>
                            <div class="col-sm-3 col-xs-12">
                                {!! Form::number('quantity',null, ['class' => 'form-control thetarget']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white" href="{{ url($main_url.'/manage/'.$production->id_outlet_production) }}">
