...
<div id="wrapper">
  ...
  <div id="page-wrapper" class="gray-bg">
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>Tambah Item Hasil Produksi</h2>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active">
                        <strong>Tambah Item Hasil Produksi</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tambah Produk ke Produksi "<?=$production->production_code?>"</h5>
                    </div>
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url($main_url.'/store/item/'.$production->id_outlet_production), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
