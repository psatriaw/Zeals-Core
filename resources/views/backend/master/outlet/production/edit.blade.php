            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::model($data,['url' => url($main_url.'/update/'.$data->id_outlet_production), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
...
<script>
  $(document).ready(function() {
    ...
    $('#production_date').datepicker("setDate",new Date(<?=strtotime($data->production_date)*1000?>));
