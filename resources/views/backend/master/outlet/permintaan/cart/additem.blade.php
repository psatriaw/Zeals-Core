    ...
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ url($main_url.'/order/'.$data->id_cart) }}">Kelola Transaksi</a>
                    </li>
                    <li class="active">
                        <strong>Tambah Item Produk</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tambah Item Produk ke Keranjang "<?=$data->cart_code?>"</h5>
                    </div>
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url($main_url.'/cart/'.$data->id_cart.'/store'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white" href="{{ url($main_url.'/order/'.$data->id_cart) }}">
