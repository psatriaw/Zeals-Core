            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url('admin/brand/store'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate', "enctype" => "multipart/form-data"]) !!}
                        ...
                        <div class="form-group {{ ($errors->has('brand_avatar')?"has-error":"") }}"><label class="col-sm-2 control-label">Brand Avatar <sub>(square image will be good)</sub></label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::file('brand_avatar', null, ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('brand_code')?"has-error":"") }}"><label class="col-sm-2 control-label">Brand code</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::text('brand_code', null, ['class' => 'form-control disabled','readonly' => 'readonly', 'disabled' => true]) !!}
