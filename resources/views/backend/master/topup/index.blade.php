                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($previlege->isAllow($login->id_user, $login->id_department, $config['approve']) && $value->status != 'paid') { ?>
                                                            <a data-id="{{ $value->id_transaksi }}" data-url="{{ url('master/topup/approve/' . $value->id_transaksi) }}" class="btn btn-primary btn-outline dim btn-xs confirm tooltips text-white btn-rounded" title="approve data <?= $value->trx_code ?>">Approve</a>
                                                        <?php }else{ ?>
                                                        ...
                                                        <?php if ($previlege->isAllow($login->id_user, $login->id_department, $config['view'])) { ?>
                                                            <a href="{{ url('master/topup/detail/' . $value->id_transaksi) }}" class="btn btn-white btn-outline dim btn-xs" title="detail data <?= $value->trx_code ?>">Detail</a>
                                                        <?php }else{ ?>
