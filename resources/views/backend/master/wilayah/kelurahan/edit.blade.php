    ...
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ url('master/wilayah') }}">Kecamatan</a>
                    </li>
                    <li>
                        <a href="{{ url('master/wilayah/manage/'.$id) }}">Kelola Kecamatan</a>
                    </li>
                    <li class="active">
                        <strong>Ubah Kelurahan</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::model($data,['url' => url('master/wilayah/kelurahan/update/'.$data->id_kelurahan.'/'.$id), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        <div class="form-group {{ ($errors->has('nama_kecamatan')?"has-error":"") }}"><label class="col-sm-2 control-label">Nama Kecamatan</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::text('nama_kecamatan', $data_parent->nama_kecamatan, ['class' => 'form-control disabled','readonly' => true]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white" href="{{ url('master/wilayah/manage/'.$id) }}">
