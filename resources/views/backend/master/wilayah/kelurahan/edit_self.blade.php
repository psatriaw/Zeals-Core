            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      ?>
                      {!! Form::model($data,['url' => url('master/kelurahan/update/'.$data->id_kelurahan), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        <div class="form-group {{ ($errors->has('id_kecamatan')?"has-error":"") }}"><label class="col-sm-2 control-label">Nama Kecamatan</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::select('id_kecamatan', array(), $data->id_kecamatan, ['class' => 'form-control thetarget','id' => 'id_kecamatan']) !!}
...
<script>
  $(document).ready(function() {
    ...
    $("#id_kecamatan").html('<option value="<?=$data->id_kecamatan?>" selected><?=$data->nama_kecamatan?></option>');
    $(".select2-selection__rendered").html("<?=$data->nama_kecamatan?>");
  });
