            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url('master/ticket/store'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('subject')?"has-error":"") }}"><label class="col-sm-2 control-label">Subjek</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::text('subject', null, ['class' => 'form-control','rows' => '3']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('sender')?"has-error":"") }}"><label class="col-sm-2 control-label">Pembuat</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::select('sender', array(), null, ['class' => 'form-control thetarget','rows' => '3']) !!}
                                {!! $errors->first('sender', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group {{ ($errors->has('target')?"has-error":"") }}"><label class="col-sm-2 control-label">Penerima</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::select('target', array(), null, ['class' => 'form-control thetarget','rows' => '3']) !!}
                                {!! $errors->first('target', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group {{ ($errors->has('status')?"has-error":"") }}"><label class="col-sm-2 control-label">Status</label>
                            <div class="col-sm-4 col-xs-12">
                              {!! Form::select('status', ['open' => 'Dibuka', 'close' => 'Selesai/Tutup'], null, ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white" href="{{ url('admin/ticket') }}">
