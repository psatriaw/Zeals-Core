            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url('admin/namecards/save'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate novalidate']) !!}
                      ...
                      <div class="form-group {{ ($errors->has('slug')?"has-error":"") }}"><label class="col-sm-2 control-label">Slug</label>
                        ...
                        <div class="form-group {{ ($errors->has('slug')?"has-error":"") }}"><label class="col-sm-2 control-label">QRcode</label>
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <input type="file" name="qrcode" style="display:none;" id="qrcode">
                                {!! $errors->first('slug', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
                            </div>
                        </div>
