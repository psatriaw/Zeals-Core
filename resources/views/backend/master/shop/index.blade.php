                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a class="btn btn-primary btn-sm" href="{{ url('admin/user/create') }}">
                          ...
                          <div class="col-sm-1">
                            <div class="input-group m-b">
                                  ...
                                  <ul class="dropdown-menu">
                                    <?php
                                      foreach($shorter as $key=>$val){
                                        ?>
                                        <li><a href="<?=url('admin/shop/?page='.@$input['page'].'&keyword='.@$input['keyword'].'&short='.$key.'&shortmode='.@$input['shortmode'])?>"><?=$val?></a></li>
                                        <?php
                                      }
                                    ?>
                                  </ul>
                              ...
                              <div class="input-group-btn bg-white">
                                  ...
                                  <ul class="dropdown-menu">
                                      <li><a href="<?=url('admin/shop/?page='.@$input['page'].'&keyword='.@$input['keyword'].'&short='.@$input['short'].'&shortmode=asc')?>">asc</a></li>
                                      <li><a href="<?=url('admin/shop/?page='.@$input['page'].'&keyword='.@$input['keyword'].'&short='.@$input['short'].'&shortmode=desc')?>">desc</a></li>
                                  </ul>
                              </div>
                              ...
                              if($data){
                                foreach ($data as $key => $value) {
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="<?=$value->shortlink?>" target="_blank" class="text-info"><?=$value->shortlink?></a></td>
                                    ...
                                    <td>
                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,"admin-master-user-create")){?>
                                          <a href="{{ url('admin/shop/edit/'.$value->id_shop) }}" class="btn btn-primary btn-outline dim btn-xs"><i class="fa fa-paste"></i> ubah</a>
                                      <?php }?>

                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,"admin-master-user-create")){?>
                                          <a href="{{ url('admin/shop/detail/'.$value->id_shop) }}" class="btn btn-white btn-outline dim btn-xs"><i class="fa fa-eye"></i> detail</a>
                                      <?php }?>

                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,"admin-master-user-create")){?>
                                          <a data-id="{{ $value->id_shop }}" data-url="{{ url('admin/shop/remove/') }}" class="btn btn-danger btn-outline dim btn-xs confirm"><i class="fa fa-trash"></i> hapus</a>
                                      <?php }?>
                                    </td>
                                  </tr>
                                  <?php
