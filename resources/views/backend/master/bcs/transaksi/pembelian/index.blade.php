        ...
        <div class="ibox-deck">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group row">
                        <label for="namaBrand" class="col-sm-5 col-form-label">Brand </label>
                        <div class="col-sm-7">
                            <select name="nama_brand" id="namaBrand" class="form-control"></select>
                            <input type="hidden" id="brand_id" class="form-control">                         
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="harga_satuan" class="col-sm-5 col-form-label">Harga Satuan</label>
                        <div class="col-sm-7">
                            <input type="number" name="harga" id="harga" class="form-control" placeholder="Harga Satuan" required>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <div class="col-md-6">
            <div class="ibox">
                ...
                <div class="ibox-content">
                  ...
                  <div class="form-group row">
                    <label for="input_supplier" class="col-sm-5 col-form-label">Supplier</label>
                    <div class="col-sm-7">
                      <select name="input_supplier" class="form-control" id="input_supplier">
                      <option value="">- Pilih -</option>
                      @foreach($optsupplier as $value)
                ...
                <?php if($kode_datang){?>
                    ...
                    @foreach($kode_datang as $d)
                        <tr>
                            ...
                            <th> 
                            <a class="btn btn-primary btn-sm" href="{{ route('pembelian.detail', $d->id) }}"><i class="fa fa-eye"></i></a>
                            </th>
                        </tr>
                    @endforeach
                        <?php } ?>
...
$(document).ready(function() {
    ...
    $('#namaBrand').select2({
        ...
        $('#input_supplier').on('change',function(){
        var supplier = $('#input_supplier').val();
    ...
    $('#tambah').on('click', function(){
        ...
        var harga = $('#harga').val();
        var brand = $('#namaBrand option:selected').text();
...
// console.log(idbrand);
        var list = '<tr id="row'+no+'">'
                        ...
                        +'</td>'
                        +'<td>'
                            +'<input name="brand[]" class="form-control col-md-12" id="brand'+ no +'" readonly>'
