            ...
            <div class="ibox-content">
              ...
              <div class="row">
                <div class="col-md-12">
                  <h4>
                    ...
                    <small class="pull-right">{{ $kode_datang->created_at }}</small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  Supplier
                  <address>
                    <strong>{{ $kode_datang->bcs_supplier[0]->nama}}</strong><br>
                  </address>
                </div>
                <!-- /.col -->
                <!-- <div class="col-sm-4 invoice-col">
              ...
              <div class="row">
                <div class="col-md-12 table-responsive">
                  <table id="table1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      <td>{{ $b->kode_barang }}</td>
                      <td>{{ $b->jenis_barang[0]->jenis }}</td>
                      <td>{{ $b->brand_barang[0]->brand }}</td>
                      <td>{{ $b->jumlah}}</td>
                ...
                <div class="col-md-5 pull-right">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <th>Total:</th>
                        <td>Rp {{ number_format($kode_datang->total) }}</td>
                      </tr>
                    </table>
                  </div>
