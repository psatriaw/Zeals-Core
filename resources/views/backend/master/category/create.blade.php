                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            {!! Form::open(['url' => url('master/category/store'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate novalidate']) !!}
                            ...
                            <div class="form-group {{ ($errors->has('nama_sektor_industri')?"has-error":"") }}"><label class="col-sm-2 control-label">Industry Name</label>
                                <div class="col-sm-4 col-xs-12">
                                    {!! Form::text('nama_sektor_industri', null, ['class' => 'form-control']) !!}
                            ...
                            <div class="form-group {{ ($errors->has('icon')?"has-error":"") }}"><label class="col-sm-2 control-label">Icon</label>
                              <div class="col-sm-6 col-xs-12">
                                ...
                                <input type="file" name="icon" style="display:none;" id="icon">
