    ...
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Tambah Bahan Baku pada "<?=$data->package_name?>"</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url($main_url.'/store/'.$id), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
