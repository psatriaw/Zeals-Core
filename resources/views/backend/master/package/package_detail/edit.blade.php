    ...
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Ubah Bahan Baku pada "<?=$data->package_name?>"</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::model($detail,['url' => url($main_url.'/update/'.$parent.'/'.$id), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}

                        <div class="form-group {{ ($errors->has('package_name')?"has-error":"") }}"><label class="col-sm-2 control-label">Nama Paket</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::text('package_name', $data->package_name, ['class' => 'form-control','readonly' => true]) !!}
                        ...
                        <div class="form-group {{ ($errors->has('id_material')?"has-error":"") }}"><label class="col-sm-2 control-label">Bahan Baku</label>
                            <div class="col-sm-4 col-xs-12">
                              <div class="input-group">
                                ...
                                {!! Form::select('id_material', $materials, null, ['class' => 'form-control']) !!}
                              </div>
                        ...
                        <div class="form-group {{ ($errors->has('quantity')?"has-error":"") }}"><label class="col-sm-2 control-label">Quantity</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::text('quantity', null, ['class' => 'form-control thetarget','rows' => '3']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white" href="{{ url($main_url.'/manage/'.$parent) }}">
