            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::open(['url' => url('admin/module/store'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('id_department')?"has-error":"") }}"><label class="col-sm-2 control-label">Group User *)</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::select('id_department[]', $optdepartment, null, ['class' => 'form-control select2',"multiple" => "multiple"]) !!}
                                <span class="help-block">*) for managing the previleges</span>
