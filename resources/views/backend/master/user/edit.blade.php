                      ...
                      {!! Form::model($data,['url' => url('admin/user/update/'.$data->id_user), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('password')?"has-error":"") }}"><label class="col-sm-2 control-label">Password</label>
                            <div class="col-sm-4 col-xs-12">
                                ...
                                <span class="help-block">Leave it blank if you do not want to change the password</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ ($errors->has('id_brand')?"has-error":"") }} brand-area" <?=($data->department_code=="BRAND")?"":"style='display:none;'"?>>
                            ...
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::select('id_brand', $brands, $data->id_brand,['class' => 'form-control','placeholder' => "Select Brand ID"]) !!}
