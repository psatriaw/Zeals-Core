                      ...
                      <div class="row">
                        <div class="col-sm-6 col-xs-12">
                          <h3>Personal Information</h3>
                            ...
                            <div class="form-group {{ ($errors->has('first_name')?"has-error":"") }}"><label class="col-sm-4 control-label">First Name</label>
                            ...
                            <div class="form-group {{ ($errors->has('last_name')?"has-error":"") }}"><label class="col-sm-4 control-label">Last Name</label>
                                <div class="col-sm-8 col-xs-12">
                            ...
                            <div class="form-group {{ ($errors->has('phone')?"has-error":"") }}"><label class="col-sm-4 control-label">Phone</label>
                                <div class="col-sm-8 col-xs-12">
                            ...
                            <div class="form-group {{ ($errors->has('username')?"has-error":"") }}"><label class="col-sm-4 control-label">Username</label>
                                <div class="col-sm-8 col-xs-12">
                            ...
                            <div class="form-group {{ ($errors->has('address')?"has-error":"") }}"><label class="col-sm-4 control-label">Address</label>
                                <div class="col-sm-8 col-xs-12">
                            ...
                            <div class="form-group {{ ($errors->has('password')?"has-error":"") }}"><label class="col-sm-4 control-label">Password</label>
                                <div class="col-sm-8 col-xs-12">
                        ...
                        <div class="col-sm-6 col-xs-12">
                          ...
                          <div class="form-group {{ ($errors->has('address')?"has-error":"") }}"><label class="col-sm-4 control-label">Brand Name</label>
                              <div class="col-sm-8 col-xs-12">
                                  {!! Form::text('address', $brand->nama_penerbit, ['class' => 'form-control','readonly']) !!}
                                  {!! $errors->first('address', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
                              </div>
                          </div>
                          <div class="form-group {{ ($errors->has('address')?"has-error":"") }}"><label class="col-sm-4 control-label">No Telp</label>
                              <div class="col-sm-8 col-xs-12">
                                  {!! Form::text('address', $brand->no_telp, ['class' => 'form-control','readonly']) !!}
                                  {!! $errors->first('address', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
