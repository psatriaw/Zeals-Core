    ...
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ url($main_url) }}">Stok_barang</a>
                    </li>
                    <li class="active">
                        <strong>Ubah Stok_barang</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::model($data,['url' => url($main_url.'/update/'.$data->id), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('stok_barang')?"has-error":"") }}"><label class="col-sm-2 control-label">Nama Stok_barang</label>
