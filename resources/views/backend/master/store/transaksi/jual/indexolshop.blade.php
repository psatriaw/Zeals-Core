        ...
        <div class="ibox">
            <div class="ibox">
                ...
                <div class="ibox-content">
                  ...
                  <div class="form-group row">
                    <label for="input_sale_type" class="col-sm-5 col-form-label">Tipe Harga</label>
                    <div class="col-sm-7">
                      <select type="input_sale_type" class="form-control" id="input_sale_type" placeholder="sale_type">
