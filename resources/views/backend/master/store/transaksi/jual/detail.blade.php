            ...
            <div class="ibox-content p-3 mb-3">
              ...
              <div class="row">
                <div class="col-md-12">
                  <h4>
                    ...
                    <small class="pull-right">{{ $kode_jual[0]->created_at }}</small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  <!-- Ke -->
                  <address>
                    <!-- <strong>{{ $kode_jual[0]->toko_id }}</strong><br> -->
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                ...
                <div class="col-md-12 table-responsive">
                  <table id="table1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$methods['edit'])){?>
                      <td>
                                          <a href="{{ route('jual_edit_admin',$b->id) }}" class="btn btn-primary dim btn-xs"><i class="fa fa-paste"></i> ubah</a>
                                      <?php }?>

                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$methods['remove'])){?>
                                          <a data-id="{{ $b->id }}" data-url="{{ route('jual_hapus_admin',$b->id) }}" class="btn btn-danger btn-outline dim btn-xs confirm"><i class="fa fa-trash"></i> hapus</a>
                                    </td>
                                      <?php }?>
                    </tr>
                    @endforeach
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  ...
                  <div class="table-responsive">
                    ...
                    <tr>
                        <th>Total Awal:</th>
                        <td>Rp {{ number_format($kode_jual[0]->total_awal) }}</td>
                    </tr>
                        <th>Diskon:</th>
                        <td>Rp {{ number_format($kode_jual[0]->diskon) }}</td>
                      <tr>
                        <th>Total:</th>
                        <td>Rp {{ number_format($kode_jual[0]->total) }}</td>
                      </tr>
                    </table>
                  </div>
