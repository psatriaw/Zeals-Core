                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::model($unit_barang,['url' => url($main_url.'/update_admin/'.$unit_barang->id), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('transfer')?"has-error":"") }}"><label class="col-sm-2 control-label">Kode</label>
                        ...
                        <div class="form-group {{ ($errors->has('status')?"has-error":"") }}"><label class="col-sm-2 control-label">Status </label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::select('status', ['Diajukan'=>'Diajukan','Diproses'=>'Diproses','Diterima'=>'Diterima','Lunas'=>'Lunas','Selesai'=>'Selesai','Retur'=>'Retur'], null, ['class' => 'form-control']) !!}
