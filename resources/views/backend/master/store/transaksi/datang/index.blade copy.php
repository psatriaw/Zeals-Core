...
<div class="content mt-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <input type="hidden" id="kd_datang" value="{{ $kd_datang }}">
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h4><span class="fa fa-shopping-cart"></span> Cart Kedatangan</h4>
                </div>
                <div class="col-md-6">
            ...
            <hr>
            <form action="{{ route('save_transaksi_masuk') }}" method="POST">
            @csrf
...
$(document).ready(function() {
    // var kode_datang= $.ajax({
    //     url:"{{ route('ajax_kode_datang') }}",
    //     method: "GET",
    //     // destroy: "TRUE",
    //     data: {kode_datang:kode_datang},
    //     success: function(result){
    //     $('#kode_datang').html(result);
    //     $('#kd_datang').html(result);
    //     }
    // });
    // console.log(kode_datang);
    ...
    $('#tambah').on('click', function(){
        ...
        var list = '<div class="row" id="row'+ no +'" style="margin-bottom:10px;">'
                        +'<div class="col-md-2">'
                            ...
                            +'<input type="hidden" name="kd_datang[]" id="kd_datang'+ no +'">'
                        +'</div>'
                        +'<div class="col-md-2">'
