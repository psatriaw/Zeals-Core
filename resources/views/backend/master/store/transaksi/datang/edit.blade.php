                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::model($unit_barang,['url' => url($main_url.'/update_admin/'.$unit_barang->id), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}
                        ...
                        <div class="form-group {{ ($errors->has('jumlah_datang')?"has-error":"") }}"><label class="col-sm-2 control-label">Jumlah</label>
                            <div class="col-sm-4 col-xs-12">
                                {!! Form::number('jumlah_datang', null, ['class' => 'form-control']) !!}
                                {!! $errors->first('jumlah_datang', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>') !!}
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white" href="{{ route('detail_datang', $unit_barang->store_kode_datang_id) }}">
