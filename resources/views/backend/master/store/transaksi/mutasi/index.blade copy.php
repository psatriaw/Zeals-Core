...
<div class="content mt-3">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="form-group row col-md-3">
                    <label for="ke" class="col-sm-5 col-form-label">Tujuan Mutasi:</label>
                    <div class="col-sm-5">
                        <select  id="tujuan_mutasi" class="form-control">
        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <input type="hidden" id="kd_mutasi" value="{{ $kd_mutasi }}">
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="number" name="hpp" id="h_awal" value="" class="form-control" placeholder="Harga">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h4><span class="fa fa-shopping-cart"></span> Cart Mutasi</h4>
                </div>
                <div class="col-md-6">
            ...
            <hr>
            <form action="{{ route('save_transaksi_mutasi') }}" method="POST" id="mutasi">
            @csrf
...
$(document).ready(function() {
    ...
    $('#tambah').on('click', function(){
        ...
        var list = '<div class="row" id="row'+ no +'" style="margin-bottom:10px;">'
                        +'<div class="col-md-2">'
                            ...
                            +'<input type="hidden" name="kd_mutasi[]" id="kd_mutasi'+ no +'">'
                        +'</div>'
                        +'<div class="col-md-2">'
    ...
    $('#tujuan_masuk').on('keyup', function(){   
    var ke= $('#tujuan_mutasi').val();
    $('#ke').val(ke);
    // console.log(ke);     
    });
