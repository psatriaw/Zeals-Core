          ...
          <div class="ibox">
            ...
            <div class="ibox-content p-3 mb-3">
              ...
              <div class="row">
                <div class="col-md-12">
                  <h4>
                    <i class="fas fa-globe"></i> Detail Barang Retur
                    <small class="pull-right">{{ $kode_retur[0]->created_at }}</small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
                ...
                <div class="col-md-12 table-responsive">
                  <table id="table1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$methods['edit'])){?>
                      <td>
                                          <a href="{{ route('retur_edit_admin',$b->id) }}" class="btn btn-primary dim btn-xs"><i class="fa fa-paste"></i> ubah</a>
                                      <?php }?>

                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$methods['remove'])){?>
                                          <a data-id="{{ $b->id }}" data-url="{{ route('retur_hapus_admin',$b->id) }}" class="btn btn-danger btn-outline dim btn-xs confirm"><i class="fa fa-trash"></i> hapus</a>
                                    </td>
                                      <?php }?>
                    </tr>
                    @endforeach
                ...
                <div class="col-md-5 ">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <th>Total:</th>
                        <td>Rp {{ number_format($kode_retur[0]->total) }}</td>
                      </tr>
                    </table>
                  </div>
                  <form action="{{ route('barang_retur.index') }}" method="GET">
