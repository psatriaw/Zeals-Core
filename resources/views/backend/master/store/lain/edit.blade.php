    ...
    <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ url($main_url) }}">Lain</a>
                    </li>
                    <li class="active">
                        <strong>Ubah Lain</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      {!! Form::model($lain,['url' => url($main_url.'/update/'.$lain->id), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']) !!}

                        <div class="form-group {{ ($errors->has('lain')?"has-error":"") }}"><label class="col-sm-2 control-label">Tanggal</label>
                        ...
                        <div class="form-group {{ ($errors->has('catatan')?"has-error":"") }}"><label class="col-sm-2 control-label">Keterangan</label>
                            <div class="col-sm-4 col-xs-12">
