                        ...
                        <div class="ibox-title">
                            ...
                            <?php if ($previlege->isAllow($login->id_user, $login->id_department, $config['create'])) { ?>
                                <div class="ibox-tools">
                                    <a class="btn btn-secondary btn-sm" href="{{ url('master/laporan-campaign/create/'.@$id_penerbit.'?backlink='.$main_url) }}">
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      ...
                                                      <?php if ($previlege->isAllow($login->id_user, $login->id_department, $config['manage'])) { ?>
                                                          <a href="{{ url('master/laporan-campaign/detail/'.$value->id_report.'?backlink=master/campaign/manage/'.$value->id_campaign) }}" class="btn btn-primary btn-rounded dim btn-xs"><i class="fa fa-cogs"></i> kelola </a>
                                                      <?php } ?>
