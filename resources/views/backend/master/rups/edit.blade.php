        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Ubah RUPS Penerbit</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            {!! Form::model($data,['url' => url($main_url.'/update/'.$data->id_rups), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate novalidate']) !!}

                            <div class="form-group {{ ($errors->has('id_penerbit')?"has-error":"") }}"><label class="col-sm-2 control-label">Penerbit</label>
                                <div class="col-sm-4 col-xs-12">
                                    {!! Form::select('id_penerbit', $penerbits, $data->id_penerbit, ['class' => 'form-control','id' => 'id_penerbit']) !!}
                            ...
                            <div class="form-group {{ ($errors->has('id_campaign')?"has-error":"") }}"><label class="col-sm-2 control-label">Campaign/Penawaran</label>
                                <div class="col-sm-4 col-xs-12">
                                    {!! Form::select('id_campaign', $campaigns ,$data->id_campaign, ['class' => 'form-control','id' => 'id_campaign']) !!}
                            ...
                            <div class="form-group {{ ($errors->has('tanggal_rups')?"has-error":"") }}"><label class="col-sm-2 control-label">Tanggal RUPS</label>
                                <div class="col-sm-4 col-xs-12">
                                    {!! Form::text('tanggal_rups', $data->tanggal_rups, ['class' => 'form-control','id' => 'tanggal_rups']) !!}
                            ...
                            <div class="form-group {{ ($errors->has('notif_email')?"has-error":"") }}"><label class="col-sm-2 control-label">Notifikasi Email</label>
                                <div class="col-sm-4 col-xs-12" style="padding-top:7px;">
                                    {!! Form::checkbox('notif_email', 'yes', ($data->notif_email=='yes')?true:false) !!}
                            ...
                            <div class="form-group {{ ($errors->has('notif_push')?"has-error":"") }}"><label class="col-sm-2 control-label">Notifikasi Push (Apps)</label>
                                <div class="col-sm-4 col-xs-12" style="padding-top:7px;">
                                    {!! Form::checkbox('notif_push', 'yes', ($data->notif_push=='yes')?true:false) !!}
