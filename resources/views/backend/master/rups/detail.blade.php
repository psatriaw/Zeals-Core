                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group {{ ($errors->has('nama_penerbit')?"has-error":"") }}"><label class="col-sm-2 control-label">Nama Penerbit</label>
                                <div class="col-sm-4 col-xs-12">
                            ...
                            <div class="form-group {{ ($errors->has('photos')?"has-error":"") }}"><label class="col-sm-2 control-label">Gambar Penerbit</label>
                                <div class="col-sm-4 col-xs-12">
