                          ...
                          <td class="nowrap">
                            <div class="btn-group" role="group">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li>
                                  <a href="{{ url('master/microsite/edit/'.$value->id_component) }}" class=""><i class="fa fa-paste"></i> edit</a>
                                </li>
                                <?php }?>

                                <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['edit'])){?>
                                <li>
                                  <a href="{{ url('master/microsite/manage/'.$value->id_component) }}" class=""><i class="fa fa-eye"></i> manage</a>
                                </li>
                                <?php }?>

                                <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['report'])){?>
                                <li>
                                  <a href="{{ url('master/microsite/report/'.$value->id_component) }}" class=""><i class="fa fa-eye"></i> report</a>
                                </li>
                                <?php }?>

                                <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['remove'])){?>
                                <li class="text-danger">
                                  <a data-id="{{ $value->id_component }}" data-url="{{ url('master/microsite/remove/') }}" class="confirm"><i class="fa fa-trash"></i> remove</a>
                                </li>
                                <?php }?>
                              </ul>
                            </div>
