              ...
              <div class="col-12">
                ...
                <div class="form-group text-center top30">
                  <p class="text-grey p1">
                    Forget Password? Reset <a href="{{ url('forgot-password') }}">Here</a><br>
                    or you may try another sign in method below
                  </p>
                    <a href="{{ url('startAuthGoogle') }}" class="btn btn-google btn-login mt-4 mb-3"><i class='fa fa-google'></i> google account</a>
                </div>
                <div class="form-group text-center">
                  <p class="text-grey p1"><a href="{{ url('register') }}" class="text-grey"><strong>Register</strong></a> new Account Here</p>
                </div>
            </div>
          </div>
          {!! Form::close() !!}
