<main role="main">
  ...
  <section class="jumbotron text-center">
    ...
    <div class="container text-center top100">
      <h3>Ubah data alamat</h3>
      <p class="text-gray">Mohon memberikan alamat yang presisi agar proses pengiriman lebih optimal</p>
      <p class="description"><a href='{{ url('address') }}' class="text-black"><i class='fa fa-arrow-left'></i> kembali</a></p>
    </div>
  </section>
  ...
  <div class="album pb-5">
    <div class="container">
      <div class="album-content">
        {!! Form::model($detail,['url' => url('address-update/'.$detail->id_shipping_address), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate', "enctype" => "multipart/form-data"]) !!}
