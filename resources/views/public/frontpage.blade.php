...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ url('templates/app/favicon.ico') }}">
    ...
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/bootstrap/bootstrap.min.css') }}">

    <!-- CSS Implementing Plugins -->
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/icon-awesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/icon-line/css/simple-line-icons.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/icon-hs/style.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/hamburgers/hamburgers.min.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/animate.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/dzsparallaxer/dzsparallaxer.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/dzsparallaxer/dzsscroller/scroller.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/dzsparallaxer/advancedscroller/plugin.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/fancybox/jquery.fancybox.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/cubeportfolio-full/cubeportfolio/css/cubeportfolio.min.css') }}">
    <link rel="stylesheet" href="{{ url('templates/app/assets/vendor/slick-carousel/slick/slick.css') }}">

    <!-- CSS Template -->
    <link rel="stylesheet" href="{{ url('templates/app/assets/css/styles.op-app.css') }}">

    <!-- CSS Customization -->
    <link rel="stylesheet" href="{{ url('templates/app/assets/css/custom.css') }}">
  </head>
  ...
  <body>
    <main>
          ...
          <nav class="navbar navbar-expand-lg py-0 g-px-15">
            <div class="container g-pos-rel">
              ...
              <a href="#!" class="js-go-to navbar-brand u-header__logo"
                 data-type="static" style="    font-size: 28px;font-weight: 700;">
                uronShop
              </a>
              <!-- End Logo -->
              ...
              <div id="navBar" class="collapse navbar-collapse">
                ...
                <a class="btn btn-lg text-uppercase u-btn-primary g-font-weight-700 g-font-size-11 g-rounded-10 g-px-13 g-py-10 mb-0 g-ml-25--lg" href="{{ url('login') }}">Try trail version</a>
              </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 col-lg-6 g-overflow-hidden">
              <img class="img-fluid" src="{{ url('templates/app/assets/img-temp/mockups/mockup1.png') }}" alt="Image description"
        ...
        <div class="container px-0">
          <div class="row no-gutters">
            <div class="col-sm-6 col-lg-3 g-bg-primary">
              ...
              <article class="u-block-hover">
                <figure class="g-overflow-hidden">
                  <img class="img-fluid u-block-hover__main--zoom-v1" src="{{ url('templates/app/assets/img-temp/800x466/img1.jpg') }}" alt="Image description">
                </figure>
            ...
            <div class="col-sm-6 col-lg-3 g-bg-darkpurple">
              ...
              <article class="u-block-hover">
                <figure class="g-overflow-hidden">
                  <img class="img-fluid u-block-hover__main--zoom-v1" src="{{ url('templates/app/assets/img-temp/800x466/img2.jpg') }}" alt="Image description">
                </figure>
            ...
            <div class="col-sm-6 col-lg-3 g-bg-pink">
              ...
              <article class="u-block-hover">
                <figure class="g-overflow-hidden">
                  <img class="img-fluid u-block-hover__main--zoom-v1" src="{{ url('templates/app/assets/img-temp/800x466/img3.jpg') }}" alt="Image description">
                </figure>
            ...
            <div class="col-sm-6 col-lg-3 g-bg-purple">
              ...
              <article class="u-block-hover">
                <figure class="g-overflow-hidden">
                  <img class="img-fluid u-block-hover__main--zoom-v1" src="{{ url('templates/app/assets/img-temp/800x466/img4.jpg') }}" alt="Image description">
                </figure>
        ...
        <div class="container">
          ...
          <div class="js-carousel g-pb-20"
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img1.jpg') }}"
                 data-title="Custom Title 1"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img1.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img2.jpg') }}"
                 data-title="Custom Title 2"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img2.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img3.jpg') }}"
                 data-title="Custom Title 3"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img3.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img4.jpg') }}"
                 data-title="Custom Title 4"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img4.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img5.jpg') }}"
                 data-title="Custom Title 5"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img5.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img6.jpg') }}"
                 data-title="Custom Title 6"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img6.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img7.jpg') }}"
                 data-title="Custom Title 7"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img7.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img8.jpg') }}"
                 data-title="Custom Title 8"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img8.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img9.jpg') }}"
                 data-title="Custom Title 9"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img9.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img10.jpg') }}"
                 data-title="Custom Title 10"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img10.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img11.jpg') }}"
                 data-title="Custom Title 11"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img11.jpg') }}" alt="Image description">
            ...
            <div class="js-slide text-center g-px-15">
              <a class="cbp-lightbox d-inline-block g-pos-rel g-parent" href="{{ url('templates/app/assets/img-temp/270x481/img12.jpg') }}"
                 data-title="Custom Title 12"
                 data-cbp-lightbox="whatsNewCarousel">
                <img src="{{ url('templates/app/assets/img-temp/270x481/img12.jpg') }}" alt="Image description">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 text-center g-overflow-hidden g-mb-50 g-mb-0--md">
              <img class="img-fluid" src="{{ url('templates/app/assets/img-temp/mockups/mockup2.png') }}" alt="Image description"
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-5 text-center g-overflow-hidden">
              <img class="img-fluid" src="{{ url('templates/app/assets/img-temp/mockups/mockup3.png') }}" alt="Image description"
                   data-animation="slideInUp">
            </div>
          </div>
        </div>
          ...
          <div class="js-carousel"
            ...
            <div class="js-slide">
              <div class="container text-center g-max-width-750">
                <div class="g-mb-20">
                  <img class="d-inline-block" src="{{ url('templates/app/assets/img-temp/mockups/mockup5.png') }}" alt="Image description">
                  <img class="d-inline-block" src="{{ url('templates/app/assets/img-temp/mockups/mockup6.png') }}" alt="Image description">
                </div>
        ...
        <div class="container">
          ...
          <div id="appScreensCubePortfolio" class="cbp"
            ...
            <div class="cbp-item home">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img1.jpg') }}"
                 data-title="Custom Title 1">
            ...
            <div class="cbp-item home">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img2.jpg') }}"
                 data-title="Custom Title 2">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img2.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item login">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img3.jpg') }}"
                 data-title="Custom Title 3">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img3.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item login">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img4.jpg') }}"
                 data-title="Custom Title 4">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img4.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item sign-up">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img5.jpg') }}"
                 data-title="Custom Title 1">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img5.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item sign-up">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img6.jpg') }}"
                 data-title="Custom Title 2">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img6.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item calender">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img7.jpg') }}"
                 data-title="Custom Title 3">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img7.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item calender">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img8.jpg') }}"
                 data-title="Custom Title 4">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img8.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item list">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img9.jpg') }}"
                 data-title="Custom Title 1">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img9.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item list">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img10.jpg') }}"
                 data-title="Custom Title 2">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img10.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item calender">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img11.jpg') }}"
                 data-title="Custom Title 3">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img11.jpg') }}" alt="Image description">
                </div>
            ...
            <div class="cbp-item sign-up">
              <a class="cbp-caption cbp-lightbox d-block" href="{{ url('templates/app/assets/img-temp/270x481/img12.jpg') }}"
                 data-title="Custom Title 4">
                <div class="cbp-caption-defaultWrap">
                  <img src="{{ url('templates/app/assets/img-temp/270x481/img12.jpg') }}" alt="Image description">
                </div>
      ...
      <section id="subscribe" class="g-theme-bg-gray-light-v1 g-pt-90">
        ...
        <div class="container text-center g-overflow-hidden">
          <img class="img-fluid" src="{{ url('templates/app/assets/img-temp/mockups/mockup4.png') }}" alt="Image description"
               data-animation="slideInUp">
        </div>
      </section>
      <!-- End Section Content -->
    ...
    <script src="{{ url('templates/app/assets/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/jquery-migrate/jquery-migrate.min.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/popper.min.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/bootstrap/bootstrap.min.js') }}"></script>

    <!-- JS Implementing Plugins -->
    <script src="{{ url('templates/app/assets/vendor/appear.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/dzsparallaxer/dzsparallaxer.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/dzsparallaxer/dzsscroller/scroller.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/dzsparallaxer/advancedscroller/plugin.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/fancybox/jquery.fancybox.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/cubeportfolio-full/cubeportfolio/js/jquery.cubeportfolio.min.js') }}"></script>
    <script src="{{ url('templates/app/assets/vendor/slick-carousel/slick/slick.js') }}"></script>

    <!-- JS Unify -->
    <script src="{{ url('templates/app/assets/js/hs.core.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/components/hs.header.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/helpers/hs.hamburgers.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/components/hs.scroll-nav.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/components/hs.onscroll-animation.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/components/hs.tabs.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/components/hs.cubeportfolio.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/components/hs.popup.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/components/hs.carousel.js') }}"></script>
    <script src="{{ url('templates/app/assets/js/components/hs.go-to.js') }}"></script>

    <!-- JS Customization -->
    <script src="{{ url('templates/app/assets/js/custom.js') }}"></script>
