...
class IndustryController extends Controller
{
    public function search(Request $request){
        ...
        $sektors      = SektorIndustri::where("nama_sektor_industri","LIKE","%$keyword%")->orderBy("nama_sektor_industri","ASC")->get();

        $result     = [];
        foreach($sektors as $index=>$pack){
            $result[] = [
                "value"     => $pack->id_sektor_industri,
                "label"     => ucfirst($pack->nama_sektor_industri)
            ];
        }
