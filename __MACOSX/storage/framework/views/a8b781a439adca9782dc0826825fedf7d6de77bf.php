            ...
            <div class="row">
              ...
              <div class="dropdown">
                <button class="btn btn-secondary btn-block dropdown-toggle text-justify" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <?=($selected_category=="")?"Categories":$categories[$selected_category]?>
                </button>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                   <?php
                    foreach ($categories as $key => $val) {
                    ?>
                      <a class="dropdown-item" href="<?= url('campaign/'.$key) ?>"><?= $val ?></a>
                    <?php } ?>
                </div>
              </div>
            </div>
                        ...
                        <div class="panel">
                          ...
                          <div class="panel-content" style="padding-left:15px;padding-right:15px;min-height:120px;">
                            ...
                            <div class="" style="height:120px;overflow:hidden;">
                              <img src="<?=url($value->photos)?>" style="max-width: 100%;padding-top: 15px;">
                            </div>
                            ...
                            <small><a href="<?php echo e(url('campaign/detail/'.$value->campaign_link)); ?>" class="text-black btn btn-secondary btn-sm text-white btn-block">open campaign <i class="fa fa-angle-right"></i> </a></small>
                          </div>
                        </div>
                      </div>
                    </div>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/frontend/campaign_list.blade.php ENDPATH**/ ?>