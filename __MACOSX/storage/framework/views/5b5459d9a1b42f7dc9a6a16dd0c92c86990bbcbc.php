          ...
          <div class="album-content">
            ...
            <div class="row">
              <div class="col-12 col-sm-6 col-md-6">
                ...
                <div class="form-group <?php echo e(($errors->has('id_job')?"has-error":"")); ?>">
                    <?php echo Form::select('id_job', $pekerjaans,null, ['class' => 'form-control select2','placeholder' => 'Select Job']); ?>

                    <?php echo $errors->first('id_job', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>'); ?>
            ...
            <div class="col-12 col-sm-6 col-md-6">
              ...
              <a href="<?php echo e(url('profile/preferences')); ?>" class="pull-right text-black btn btn-sm btn-info btn-rounded text-white"><i class="fa fa-cogs"></i> configure</a>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/frontend/profile.blade.php ENDPATH**/ ?>