                                    ...
                                    <td>
                                      ...
                                      <?php if($previlege->isAllow($login->id_user,$login->id_department,$config['approve'])){?>
                                            <?php if($value->status!="approved"){?>
                                                <a data-url="<?php echo e(url($config['main_url']) . '/approve/' . $value->id_withdrawal); ?>" class="btn btn-info btn-outline dim btn-xs confirm btn-rounded" title="approve"><i class="fa fa-check"></i> Approve/Release </a>
                                            <?php }else{ ?>
                                                approved
                                            <?php }?>
                                      <?php }?>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/backend/withdrawal/index.blade.php ENDPATH**/ ?>