                        ...
                        <tr>
                          ...
                          <td>
                            <?php if ($previlege->isAllow($login->id_user, $login->id_department, $config['edit'])) { ?>
                              <a href="<?php echo e(url('master/penerbit/edit/'.$value->id_penerbit)); ?>" class="btn btn-primary dim btn-xs btn-rounded"><i class="fa fa-paste"></i> ubah</a>
                            <?php } ?>
                            ...
                            <?php if ($previlege->isAllow($login->id_user, $login->id_department, $config["manage"])) { ?>
                              <a href="<?php echo e(url('master/penerbit/manage/'.$value->id_penerbit)); ?>" class="btn btn-white btn-outline dim btn-xs"><i class="fa fa-cogs"></i> kelola</a>
                            <?php } ?>

                            <?php if ($previlege->isAllow($login->id_user, $login->id_department, $config["remove"])) { ?>
                              <a data-id="<?php echo e($value->id_penerbit); ?>" data-url="<?php echo e(url('master/penerbit/remove/' . $value->id_penerbit)); ?>" class="btn btn-danger btn-outline dim btn-xs confirm"><i class="fa fa-trash"></i> hapus</a>
                            <?php } ?>
                          </td>
                        </tr>
                    <?php
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myzeals/resources/views/backend/master/penerbit/index.blade.php ENDPATH**/ ?>