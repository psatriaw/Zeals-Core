                  ...
                  <br>
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <!-- campaign title -->
                            <div class="form-group <?php echo e(($errors->has('campaign_title')?"has-error":"")); ?>"><label class="col-sm-2 control-label">Type</label>
                                <div class="col-sm-6 col-xs-12">
                                    <?php echo Form::text('cite', $campaigntypes[Request::segment(4)], ['class' => 'form-control','readonly']); ?>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/backend/master/campaign/create.blade.php ENDPATH**/ ?>