            ...
            <div class="row">
                <div class="col-lg-12">
                  <ul class="c-breadcrumb">
                    ...
                    <li class="completed"><a href="javascript:void(0);">Target</a></li>
                    <?php if($detail->campaign_type=="o2o"){ ?>
                    <li class="active"><a href="javascript:void(0);">Outlet Setup</a></li>
                    <?php } ?>
                  ...
                  <br>
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Setup Your Initial Outlet</h5>
                        </div>
                        <div class="ibox-content">
                            ...
                            <?php echo Form::model($detail,['url' => url('master/campaign/storeoutlet'), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate novalidate']); ?>
                            ...
                            <?php if($outlets){ ?>
                              <div class="form-group <?php echo e(($errors->has('outlet_name')?"has-error":"")); ?>"><label class="col-sm-2 control-label">Outlets</label>
                                    ...
                                    <?php
                                      foreach ($outlets as $key => $value) {
                                        ...
                                        <div class="col-6 col-sm-2 text-center">
                                          <?php echo e(QrCode::size(100)->generate($value->outlet_code)); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 text-right">
                                    <button class="btn btn-white" type="button" onclick="setAddmore()">Save & Add more Outlet <i class="fa fa-save"></i></button>
...
<?php /**PATH /home/zealsasi/new.zeals.asia/resources/views/backend/master/campaign/set_outlet.blade.php ENDPATH**/ ?>