...
<div class="middle-box text-center loginscreen animated fadeInDown">
  <div>
    ...
    <div class="form-group py-4 text-center bottom100" style="margin-bottom:50px !important;">
      <p class="text-white"><a href="<?php echo e(url('signin')); ?>" class="text-white"><strong>Sign In</strong></a> Page</p>
      <br><br>
    </div>
  </div>
</div>
    ...
    $("#loginForm").submit(function(e){
      ...
      .done(function(result){
        if(result.status=="success"){
          setTimeout(function(){
            document.location = "<?php echo e(url('user/dashboard')); ?>";
          },5000);
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/backend/user/activation.blade.php ENDPATH**/ ?>