    ...
    <div class="sidebar-collapse">
          ...
          <li <?=(in_array(true,$active))?"class='active'":""?>>
              ...
              <ul class="nav nav-second-level collapse">
                ...
                <li <?=(Request::segment(1)=="master" && Request::segment(2)=="withdrawal")?"class='active'":""?>>
                    <a href="<?php echo e(url('master/withdrawal')); ?>"><i class="fa fa-credit-card"></i> <span class="nav-label">Withdrawals</span></a>
                </li>
                <?php } ?>
          ...
          <li <?=(in_array(true,$active))?"class='active'":""?>>
              ...
              <?php } ?>
                ...
                <li <?=($active['campaign'])?"class='active'":""?>>
                    <a href="<?php echo e(url('master/campaign')); ?>"><i class="fa fa-cubes"></i> <span class="nav-label">Campaigns</span></a>
                </li>
                <?php } ?>

                <?php if($allow['laporan_campaign']){?>
                <li <?=($active['laporan_campaign'])?"class='active'":""?>>
                    <a href="<?php echo e(url('master/laporan-campaign')); ?>"><i class="fa fa-chart-line"></i> <span class="nav-label">Reports</span></a>
                </li>
                <?php } ?>
        ...
        <?php } ?>
            ...
            <?php
              ...
              $active['pengguna']     = (Request::segment(1)=="admin" && Request::segment(2)=="user" && Request::segment(3)=="")?true:false;
            ...
            <li <?=($active['user_group'] || $active['module'] || $active['pengguna'])?"class='active'":""?>>
                <a href="#"><i class="fa fa-users"></i> <span class="nav-label">Account & Access</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">

                    <?php if($allow['module']){?>
                    <li <?=($active['module'])?"class='active'":""?>>
                        <a href="<?php echo e(url('admin/module')); ?>"><i class="fa fa-minus"></i> Modules</a>
                    </li>
                    <?php } ?>

                    <?php if($allow['user_group']){?>
                      <li <?=($active['user_group'])?"class='active'":""?>>
                          <a href="<?php echo e(url('admin/group')); ?>"><i class="fa fa-minus"></i> Group User</a>
                      </li>
                    <?php } ?>

                    <?php if($allow['pengguna']){?>
                    <li <?=($active['pengguna'])?"class='active'":""?>>
                        <a href="<?php echo e(url('admin/user')); ?>"><i class="fa fa-minus"></i> Accounts</a>
                    </li>
                    <?php } ?>
                </ul>
            </li>
            ...
            <li <?=(Request::segment(1)=="master" && Request::segment(2)=="tutorial")?"class='active'":""?>>
                <a href="<?php echo e(url('master/tutorial')); ?>"><i class="fa fa-video"></i> <span class="nav-label">Tutorials</span></a>
            </li>
            <?php } ?>
            ...
            <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="user" && Request::segment(3)=="profile")?"class='active'":""?>>
                <a href="<?php echo e(url('admin/user/profile/'.$login->id_user)); ?>"><i class="fa fa-user"></i> <span class="nav-label">Account Profile</span></a>
            </li>
            <?php } ?>
            ...
            <li <?=(Request::segment(1)=="master" && Request::segment(2)=="pengaturan")?"class='active'":""?>>
                <a href="<?php echo e(url('master/pengaturan')); ?>"><i class="fa fa-cogs"></i> <span class="nav-label">System Configuration</span></a>
            </li>
            <?php } ?>
        </ul>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/backend/menus/sidebar_menu.blade.php ENDPATH**/ ?>