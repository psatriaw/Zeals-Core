...
<div class="middle-box login text-center loginscreen animated fadeInDown">
  <div>
    ...
    <form class="m-t" role="form" action="<?php echo e(url('login-submit')); ?>" method="POST" id="loginForm">
      ...
      <a href="<?php echo e(url('forgot-password')); ?>">Reset Password Here</a>
      <br>
      <br>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/backend/user/login.blade.php ENDPATH**/ ?>