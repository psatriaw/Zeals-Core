      ...
      <div class="row justify-content-md-center">
        <div class="col-12 col-sm-8 col-md-6">
          <div class="album-content text-center">
            ...
            <form class="m-t top30 text-left" role="form" action="<?php echo e(url('register-submit')); ?>" method="POST" id="registerForm">
                <input type="hidden" id="token" name="_token" value="<?php echo e(csrf_token()); ?>">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="First Name" requireds="" name="first_name" id="first_name" data-placement="right">
                    <div class="alert alert-danger" style="display:none;margin-top:5px;" id="alert-first_name"></div>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Last Name" requireds="" name="last_name" id="last_name" data-placement="right">
                    <div class="alert alert-danger" style="display:none;margin-top:5px;" id="alert-first_name"></div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="812xxx" requireds="" name="phone" id="phone" data-placement="right">
                    </div>
                    <div class="alert alert-danger" style="display:none;margin-top:5px;" id="alert-phone"></div>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Email" requireds="" name="email" id="email" data-placement="right" <?=($is_google_registration!="")?"readonly":''?> value="<?=($is_google_registration!="")?$google_email:''?>">
                ...
                <div class="form-group">
                    <div class="checkbox i-checks text-grey p1"><label> <input type="checkbox" name="agree"><i></i> I agree to the <a href="<?=url("kebijakan")?>" target="_blank">Terms & Conditions </a></label></div>
                    <p class="alert alert-warning mt-3 text-small">Please make sure your email and phone are valid for better registration experience.</p>
                </div>
                <div id="regalert"></div>
                ...
                <div class="form-group py-4 text-center bottom100" style="margin-bottom:50px !important;">
                  <p class="p1 text-grey"><a href="<?php echo e(url('signin')); ?>" class="text-grey"><strong>Sign In</strong></a> Page</p>
                </div>
            </form>
          </div>
        </div>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/backend/user/register.blade.php ENDPATH**/ ?>