...
<div class="middle-box login text-center loginscreen animated fadeInDown">
  <div>
    ...
    <p class=" text-center"><small>Belum terdaftar? Silahkan Hubungi Administrator Brownies Cinta</small></p>
  </div>
</div>
<script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myzeals/resources/views/backend/user/reset_password.blade.php ENDPATH**/ ?>