                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group <?php echo e(($errors->has('brand_avatar')?"has-error":"")); ?>"><label class="col-sm-2 control-label">Update Foto</label>
                                <div class="col-sm-4 col-xs-12">
                            ...
                            <div class="form-group <?php echo e(($errors->has('nama_sektor_industri')?"has-error":"")); ?>"><label class="col-sm-2 control-label">Nama Sektor Industri</label>
                                <div class="col-sm-4 col-xs-12">
                                    <select name="id_sektor_industri" id="id_sektor_industri" class="form-control" value="<?= $data->nama_sektor_industri; ?>">
                                        ...
                                        <option <?=($si->id_sektor_industri == $data->id_sektor_industri)?"selected":""?> value="<?= $si->id_sektor_industri ?>"> <?php echo e($si->nama_sektor_industri); ?> </option>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/backend/master/penerbit/edit.blade.php ENDPATH**/ ?>