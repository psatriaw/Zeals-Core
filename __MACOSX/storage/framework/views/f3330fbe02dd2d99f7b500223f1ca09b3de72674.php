                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group <?php echo e(($errors->has('brand_avatar')?"has-error":"")); ?>"><label class="col-sm-2 control-label">Foto Brand</label>
                                <div class="col-sm-4 col-xs-12">
                                    <?php echo Form::file('brand_avatar', null); ?>

                                    <?php echo $errors->first('brand_avatar', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>'); ?>

                                </div>
                            </div>

                            <div class="form-group <?php echo e(($errors->has('kode_penerbit')?"has-error":"")); ?>"><label class="col-sm-2 control-label">Kode Brand</label>
                                <div class="col-sm-4 col-xs-12">
                            ...
                            <div class="form-group <?php echo e(($errors->has('id_sektor_industri')?"has-error":"")); ?>"><label class="col-sm-2 control-label">Sektor Industri</label>
                                <div class="col-sm-4 col-xs-12">
                                    <select name="id_sektor_industri" class="form-control" id="id_sektor_industri">
                                    ...
                                    <?php echo $errors->first('id_sektor_industri', '<p class="bg-danger p-xs b-r-sm m-t">:message</p>'); ?>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/backend/master/penerbit/create.blade.php ENDPATH**/ ?>