        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Ubah Sektor Industri</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <?php echo Form::model($data,['url' => url('master/category/update/'.$data->id_sektor_industri), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate novalidate']); ?>
                            ...
                            <div class="form-group <?php echo e(($errors->has('nama_sektor_industri')?"has-error":"")); ?>"><label class="col-sm-2 control-label">Sektor Industri</label>
                                <div class="col-sm-4 col-xs-12">
                                    <?php echo Form::text('nama_sektor_industri', null, ['class' => 'form-control disabled']); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myzeals/resources/views/backend/master/category/edit.blade.php ENDPATH**/ ?>