            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6 col-md-6">
                ...
                <div class="form-group <?php echo e(($errors->has('nama_bank')?"has-error":"")); ?>">
                    <?php echo Form::text('nama_bank',@$banks[$detail->nama_bank], ['class' => 'form-control','readonly','disabled' => true,'placeholder' => 'Select Bank']); ?>
...
<?php /**PATH /home2/zealsasi/new.zeals.asia/resources/views/frontend/withdraw.blade.php ENDPATH**/ ?>