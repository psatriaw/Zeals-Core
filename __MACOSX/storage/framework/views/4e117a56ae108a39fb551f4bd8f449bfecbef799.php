                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        $runningstatus = array(
                                            ...
                                            "closed"    => "<span class='text-danger'><i class='fa fa-ban'></i> Tidak Jalan/Stop</span>",
                                        ...
                                        if ($data) {
                                            foreach ($data as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ellipsis"><?php echo e($value->campaign_title); ?></td>
                                                    ...
                                                    <td class="nowrap">
                                                        <?php if($previlege->isAllow($login->id_user, $login->id_department, @$config['edits'])) { ?>
                                                            <a href="<?php echo e(url('master/campaign/edit/'.$value->id_campaign)); ?>" class="btn btn-primary dim btn-xs btn-rounded"><i class="fa fa-paste"></i> edit</a>
                                                        <?php } ?>
                                                        <!--
                                                        ...
                                                        <a href="<?php echo e(url($main_url.'/resume/' . $value->campaign_link)); ?>" class="btn btn-danger dim btn-xs tooltips" title="deactivate data <?= $value->title ?>"><i class="fa fa-cogs"></i> manage </a></a>
                                                        <a href="<?php echo e(url($main_url.'/report/' . $value->campaign_link)); ?>" class="btn btn-info btn-rounded dim btn-xs tooltips" title="deactivate data <?= $value->title ?>"><i class="fa fa-chart-pie"></i> report </a></a>

                                                        <?php if ($previlege->isAllow($login->id_user, $login->id_department, $config['remove'])) { ?>
                                                            <a data-id="<?php echo e($value->id_campaign); ?>" data-url="<?php echo e(url('master/campaign/remove/' . $value->id_campaign)); ?>" class="btn btn-danger btn-outline dim btn-xs confirm"><i class="fa fa-trash"></i> remove</a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                        <?php
...
<?php /**PATH /home/zealsasi/new.zeals.asia/resources/views/backend/master/campaign/index.blade.php ENDPATH**/ ?>