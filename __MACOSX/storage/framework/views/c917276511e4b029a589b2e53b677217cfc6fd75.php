              ...
              <?php if($tutorials){ ?>
                <?php foreach ($tutorials as $key => $value) { ?>
                  <div class="media media-tutorial">
                    <img class="mr-3" style="width: 150px;" src="http://i3.ytimg.com/vi/<?=$value->video_code?>/hqdefault.jpg" alt="Generic placeholder image">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myzeals/resources/views/frontend/tutorial.blade.php ENDPATH**/ ?>