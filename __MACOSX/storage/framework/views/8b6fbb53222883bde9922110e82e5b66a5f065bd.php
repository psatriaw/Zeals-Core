                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                      ...
                      <?php echo Form::model($data,['url' => url('admin/user/update/'.$data->id_user), 'method' => 'post', 'id' => 'formmain','class' => 'form-horizontal', 'data-parsley-validate novalidate']); ?>
                        ...
                        <div style="<?=($errors->has('gaji') || $errors->has('insentif') || $data->tipe_user==1)?"":"display:none;"?>" id="internalyes">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 text-right">
                              ...
                              <button class="btn btn-primary btn-rounded" type="submit">Perbarui</button>
                            </div>
                        </div>
                      <?php echo Form::close(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myzeals/resources/views/backend/master/user/edit.blade.php ENDPATH**/ ?>