    ...
    <div class="sidebar-collapse">
          ...
          <li <?=(in_array(true,$active))?"class='active'":""?>>
              ...
              <ul class="nav nav-second-level collapse">
                ...
                <li <?=($active['dashboard_penerbit'])?"class='active'":""?>>
                    <a href="{{ url('dashboard/penerbit') }}"><i class="fa fa-chart-pie"></i> <span class="nav-label">Brand</span></a>
                </li>
                <?php } ?>

                <?php if($allow['dashboard_pemodal']){ ?>
                <li <?=($active['dashboard_pemodal'])?"class='active'":""?>>
                    <a href="{{ url('dashboard/influencer') }}"><i class="fa fa-chart-bar"></i> <span class="nav-label">Influencer</span></a>
                </li>
              <?php } ?>
              </ul>
          </li>
          ...
          <li <?=(in_array(true,$active))?"class='active'":""?>>
              ...
              <?php } ?>
                ...
                <li <?=($active['master_penerbit'])?"class='active'":""?>>
                    <a href="{{ url('master/penerbit') }}"><i class="fa fa-users"></i> <span class="nav-label">Data Brand</span></a>
                </li>
                <?php } ?>
                ...
                <li <?=($active['master_industri'])?"class='active'":""?>>
                    <a href="{{ url('master/category') }}"><i class="fa fa-layer-group"></i> <span class="nav-label">Industri Brand</span></a>
                </li>
                <?php } ?>
          ...
          <li <?=(in_array(true,$active))?"class='active'":""?>>
              ...
              <ul class="nav nav-second-level collapse">
                ...
                <li <?=(Request::segment(1)=="master" && Request::segment(2)=="withdrawal")?"class='active'":""?>>
                    <a href="{{ url('master/withdrawal') }}"><i class="fa fa-credit-card"></i> <span class="nav-label">Withdrawals</span></a>
                </li>
                <?php } ?>
          ...
          <li <?=(in_array(true,$active))?"class='active'":""?>>
              ...
              <?php } ?>
                ...
                <li <?=($active['campaign'])?"class='active'":""?>>
                    <a href="{{ url('master/campaign') }}"><i class="fa fa-cubes"></i> <span class="nav-label">Campaigns</span></a>
                </li>
                <?php } ?>
                ...
                <!--
                    ...
                    <a href="{{ url('master/laporan-campaign') }}"><i class="fa fa-chart-line"></i> <span class="nav-label">Reports</span></a>
                </li>
                -->
                <?php } ?>
        ...
        <?php } ?>
            ...
            <li <?=(Request::segment(1)=="master" && Request::segment(2)=="tutorial")?"class='active'":""?>>
                <a href="{{ url('master/tutorial') }}"><i class="fa fa-video"></i> <span class="nav-label">Tutorials</span></a>
            </li>
            <?php } ?>
            ...
            <li <?=(Request::segment(1)=="admin" && Request::segment(2)=="user" && Request::segment(3)=="profile")?"class='active'":""?>>
                <a href="{{ url('admin/user/profile/'.$login->id_user) }}"><i class="fa fa-user"></i> <span class="nav-label">Account Profile</span></a>
            </li>
            <?php } ?>
